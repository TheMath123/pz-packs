    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          side === 'right' &&
            'data-closed:slide-out-to-right data-open:slide-in-from-right inset-y-0 right-0 h-full w-3/4 border-l-2 sm:max-w-sm',
          side === 'left' &&
            'data-closed:slide-out-to-left data-open:slide-in-from-left inset-y-0 left-0 h-full w-3/4 border-r-2 sm:max-w-sm',
          side === 'top' &&
            'data-closed:slide-out-to-top data-open:slide-in-from-top inset-x-0 top-0 h-auto border-b-2',
          side === 'bottom' &&
            'data-closed:slide-out-to-bottom data-open:slide-in-from-bottom inset-x-0 bottom-0 h-auto border-t-2',
          className,
        )}
        {...props}
      >
